              ...
              <nav class="navbar navbar-expand-lg navbar-light bg-light">
				  ...
				  <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
				    <div class="navbar-nav">
				      ...
				      <a class="nav-item nav-link" href="../Laboratorio/editarCuenta.php">Mis Datos</a>
				     	<a class="nav-item nav-link" href="../Cliente/verMuestras.php">Mis Muestras</a>
				     	<a class="nav-item nav-link" href="../Cliente/formularioCliente.php">Enviar Muestras</a>
				    </div>
				  </div>
				</nav>
