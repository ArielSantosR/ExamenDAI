...
<div class="container">
  <center><h3>Lista Muestras</h3></center>
   <div>
   		...
   		<p>Busqueda por id : <strong><?php echo $id; ?></strong></p>
	   	<a class="btn btn-primary" href="../Admin/listaMuestras.php">Volver</a>
  ...
  <tbody>
   <?php
          try{
              ...
              $sentencia = $gbd->query("SELECT * FROM  analisismuestras WHERE idAnalisisMuestras = '$id'; ");
