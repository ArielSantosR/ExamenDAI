              ...
              <nav class="navbar navbar-expand-lg navbar-light bg-light">
				  ...
				  <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
				    <div class="navbar-nav">
				      ...
				      <a class="nav-item nav-link" href="../EmpleadoTecnico/editarDatos.php">Mis Datos</a>
				     	<a class="nav-item nav-link" href="../EmpleadoTecnico/recibeAnalisis.php">Lista Muestras Ingresadas</a>
				    </div>
				  </div>
				</nav>
